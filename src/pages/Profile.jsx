...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    if (data && data.get_user_profile) {
      console.log(data?.get_user_profile[0]["posts"]);
      console.log(data?.get_user_profile[0]["saved_posts"]);
      setProfileData(data?.get_user_profile[0]);
      setUserPost(data?.get_user_profile[0]["posts"]);
      setSavedPost(data?.get_user_profile[0]["saved_posts"]);
    }
  }, [data]);
  ...
  function handleActiveButton(button) {
    ...
    useEffect(() => {
      ...
      console.log(
        "userpost",
        data.get_user_profile && data.get_user_profile[0],
        userPost
      );
    }, [userPost]);
  return (
      ...
      <div className="grid px-[105px] grid-cols-12 gap-5 my-6">
        {activeButton == "public" &&
          userPost?.map((post, _index) => {
            ...
            console.log(data?.view_all_posts[0][_num], _num);
            return (
              <div key={_index} className=" col-span-3">
                <div className="flex flex-col gap-5">
                  <img
                    ...
                    src={data?.view_all_posts[0][_num]["post_url"]}
                    alt=""
                  />
        ...
        {activeButton == "saved" &&
          savedPost?.map((post, _index) => {
            let _num = Number(post);
            console.log('num',_num,"index",_index,"post")
            console.log(data?.view_all_posts[0][_num], _num);
            return (
